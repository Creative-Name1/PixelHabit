...
//        completeHabitList.add(new Habit());
//        completeHabitList.add(new Habit("Cool habit name", "this is a description"));
//        completeHabitList.add(new Habit("Meditate twice daily", "Who could possibly set this habit", 1, 0, 2, 12));
//        completeHabitList.add(new Habit());
//        completeHabitList.add(new Habit("Eat 4-5 dozen eggs a day", "(No description)"));
//        completeHabitList.add(new Habit());
//        completeHabitList.add(new Habit());
//
//        completeHabitList.add(new Habit("Make sure to drink 6-7 glasses of water a day to stay tuff", "(no description)", 1, 0, 6, 7));

        s.saveHabitList(new ArrayList<Habit>(), completeHabitList);

        Habit[] habitArray = completeHabitList.toArray(new Habit[0]);
